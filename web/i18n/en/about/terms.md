...
these terms are applicable only when using the official decimator instance.
...
we have no way of detecting abusive behavior automatically because decimator is 100% anonymous.
