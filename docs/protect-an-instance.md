# how to protect your decimator instance
...
> [!NOTE]
> this tutorial will work reliably on the latest official version of decimator 10.
...
decimator uses it automatically to weed out bots and automated scripts.
...
4. enter the widget name (can be anything, such as "decimator")
<div align="left">
    <p>
...
5. add decimator frontend domains you want the widget to work with, you can change this list later at any time
    - if you want to use your processing instance with [decimator.tools](https://decimator.tools/) frontend, then add `decimator.tools` to the list
<div align="left">
    <p>
...
- **name** is a field for your own reference, it is not used by decimator anywhere.
...
- **`userAgents`** contains an array of allowed user agents, with support for wildcards (e.g. *`["decimatorbot/1.0", "Mozilla/5.0 * Chrome/*"]`*).
...
- if decimator detects any problem with your key file, it will be ignored and a warning will be printed to the console.
